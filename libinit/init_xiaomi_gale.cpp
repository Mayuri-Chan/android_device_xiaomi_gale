...
static const variant_info_t c3un_info = {
    ...
    .model = "23108RN04Y",
    .build_fingerprint = "Redmi/gust_global/gust:15/AP3A.240905.015.A2/OS2.0.208.0.VGPMIXM:user/release-keys"
};
...
static const variant_info_t c3ua_info = {
    ...
    .marketname = "Redmi 13C",
    .model = "23106RN0DA",
    .build_fingerprint = "Redmi/gale_global/gale:15/AP3A.240905.015.A2/OS2.0.208.0.VGPMIXM:user/release-keys"
};
...
static const variant_info_t c3upg_info = {
    ...
    .marketname = "POCO C65",
    .model = "2310FPCA4G",
    .build_fingerprint = "POCO/gust_p_global/gust:15/AP3A.240905.015.A2/OS2.0.208.0.VGPMIXM:user/release-keys"
};
...
static const variant_info_t c3upin_info = {
    ...
    .marketname = "POCO C65",
    .model = "2310FPCA4I",
    .build_fingerprint = "POCO/gale_p_global/gale:15/AP3A.240905.015.A2/OS2.0.208.0.VGPMIXM:user/release-keys"
};
